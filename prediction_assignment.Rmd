...
This time there is a very high accuracy of over 99.5%! Also the plot shows that all of the five categories are almost always correctly predicted. It is thus clear that this model is to be prefered to the previous one, and that no other model is needed.
